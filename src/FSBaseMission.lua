...
function RW_FSBaseMission:getHarvestScaleMultiplier(_, fruitTypeIndex, sprayLevel, plowLevel, limeLevel, weedsLevel, stubbleLevel, rollerLevel, beeYieldBonusPercentage, moisture)
    ...
    return (1 + self.harvestSprayScaleRatio * sprayLevel + self.harvestPlowScaleRatio * plowLevel + self.harvestLimeScaleRatio * limeLevel + self.harvestWeedScaleRatio * weedsLevel + self.harvestStubbleScaleRatio * stubbleLevel + self.harvestRollerRatio * rollerLevel + (beeYieldBonusPercentage or 0)) * math.clamp(moistureFactor, 0.5, 1.5)
